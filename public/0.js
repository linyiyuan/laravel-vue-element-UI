...
var update = __webpack_require__(81)("4a54f598", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_screenfull__ = __webpack_require__(247);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Footer_vue__ = __webpack_require__(248);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__NavBar_vue__ = __webpack_require__(253);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__menu_index__ = __webpack_require__(263);
//
//
//
//
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(81)("8c5ca3b2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(81)("56e7b0cc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ScrollPane_vue__ = __webpack_require__(257);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(81)("02d96365", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu__ = __webpack_require__(264);
...
var icon = menu.font_icon.children;
...
var ContentManage = menu.content_manage.children;
...
var CategoryManage = menu.category_manage.children;
                          ...
                          [
                            ...
                            _vm._l(menu_v.children, function(
                              ...
                              return _c(
                                ...
                                [
                                  _c("i", {
                                    staticClass: "is-children fa fa-circle-o"
                                  }),
                                  _vm._v(" "),
                                  _c(
                                    "span",
